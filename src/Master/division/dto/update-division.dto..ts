...
export class UpdateDivisionDto {
    @IsInt()
    @IsNotEmpty()
    @ApiProperty({ example: 1, description: 'ID of the division you want to update'})
    division_id: number;

    @IsString()
    @ApiProperty({ example: 'New Division Name', description: 'If you want to update the Division name'})
