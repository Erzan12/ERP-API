...
export class UpdateRecordExtendedLeaveDatesDto {
  @IsOptional()
  @IsUUID()
  @ApiProperty({
    example: 'PK UUID of existing Extended Leave Request Date Record',
    description:
  ...
  extended_leave_compensation?: LeaveCompensation;
...
export class UpdateExtendedLeaveRequestWithDetailsDto {
  @ApiProperty({ type: () => UpdateExtendedLeaveRequestDto })
  @ValidateNested()
  @Type(() => UpdateExtendedLeaveRequestDto)
  update_extended_leave_request: UpdateExtendedLeaveRequestDto;

  @ApiProperty({ type: () => [UpdateRecordExtendedLeaveDatesDto] })
  @ValidateNested({ each: true })
  @Type(() => UpdateRecordExtendedLeaveDatesDto)
  update_extended_leave_dates: UpdateRecordExtendedLeaveDatesDto[];
}
