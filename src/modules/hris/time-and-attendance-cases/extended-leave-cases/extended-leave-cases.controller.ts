...
import { ACTION_APPROVE, ACTION_CANCEL, ACTION_CREATE, ACTION_PROCESS, ACTION_READ, ACTION_REJECT, ACTION_SUBMIT, ACTION_VERIFY, EMPLOYEE_MASTERLIST, EXTENDED_LEAVE_REQUEST } from 'src/utils/constants/ability.constant';
...
export class ExtendedLeaveCasesController {
    ...
    @Post('time-and-attendance-cases/extended-leave/:extendedHrLeaveRequestId/submit')
    ...
    submitExtendedLeave(
        ...
        return this.extendedLeaveCasesService.submitExtendedLeave(extendedHrLeaveRequestId,user)
    }

    @Post('time-and-attendance-cases/extended-leave/:extendedHrLeaveRequestId/verify')
    ...
    verifyExtendedLeave(
        ...
        return this.extendedLeaveCasesService.verifyExtendedLeave(extendedHrLeaveRequestId,user)
    }

    @Post('time-and-attendance-cases/extended-leave/:extendedHrLeaveRequestId/approve')
    ...
    approveExtendedLeave(
        ...
        return this.extendedLeaveCasesService.approveExtendedLeave(extendedHrLeaveRequestId,user)
    }
    ...
    processExtendedLeave(
        ...
        return this.extendedLeaveCasesService.processExtendedLeave(extendedHrLeaveRequestId,user)
    }
    ...
    rejectExtendedLeave(
        ...
        return this.extendedLeaveCasesService.rejectExtendedLeave(extendedHrLeaveRequestId,user)
    }
    ...
    cancelExtendedLeave(
        ...
        return this.extendedLeaveCasesService.cancelExtendedLeave(extendedHrLeaveRequestId,user)
    }
}
