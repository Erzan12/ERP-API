import { Body, Controller, Get, Param, ParseUUIDPipe, Post, Put, Query, Req, Session } from '@nestjs/common';
...
export class DisciplinaryCaseController {
    constructor (private readonly disciplinaryCaseService: DisciplinaryCaseService) {}
    ...
    getDisciplinaryCase(
        ...
        return this.disciplinaryCaseService.getDisciplinaryCase(disciplinaryCaseId, user);
    }
    ...
    @ApiOperation({ summary: 'Advance every eligible respondent to their next stage; ineligible ones are left behind.' })
    ...
    updateMarkNoResponse(
        ...
        return this.disciplinaryCaseService.markNoResponse(
            partyId,
            user,
        );
    }
