import { Body, Controller, Param, ParseUUIDPipe, Post, Put, Req } from '@nestjs/common';
...
export class NoticeOfExplainationController {
    constructor (private readonly noticeOfExplainationService: NoticeOfExplainationService) {}

    @Post('employee-relations/nte/:disciplinaryCaseId/parties/:partyId')
    @ApiOperation({ summary: 'Issue an NTE to a respondent and assign reviewers' })
    IssueNte(
        ...
        return this.noticeOfExplainationService.issueNte(disciplinaryCaseId, partyId, dto, user);
    }
