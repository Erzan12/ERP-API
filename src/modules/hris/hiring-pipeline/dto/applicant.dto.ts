...
import { IsBoolean, IsDateString, IsEmail, IsEnum, IsNotEmpty, IsOptional, IsString, IsUUID } from "class-validator"
...
export class CreateApplicantDto {
    ...
    @IsString()
    @IsNotEmpty()
    @IsEnum(ApplicationSource, { message: 'Application Source must be company_website, walk_in, referral, linkedIn, jobstreet' })
    @Type(() => String)
    @ApiProperty({
    ...
    @IsString()
    @IsNotEmpty()
    @IsEnum(ApplicationStatus, { message: 'Application Status must be applied, screening, for_interview, accepted, rejected, onboarding' })
    @Type(() => String)
    @ApiProperty({
