...
import { UserManagementControllerV1 } from '../controllers/user_managementV1.controller';

@Module({
  imports: [AuthModule],
  controllers: [UserManagementControllerV1],
  providers: [
...
export class UserManagementV1Module {}
