import { Controller, Get, ParseUUIDPipe, Param, Post, Put, Body } from '@nestjs/common';

import { ApiOperation, ApiTags } from '@nestjs/swagger';
import { ApiGetResponse, ApiPostResponse, ApiSecurityClearance } from 'src/utils/helpers/swagger-response.helper';

import { RoleManagementService } from '../role-management.service';

import { Can } from 'src/utils/decorators/can.decorator';
import { ACTION_CREATE, ACTION_READ, ROLE_MANAGEMENT, SEC_LVL_5 } from 'src/utils/constants/ability.constant';
