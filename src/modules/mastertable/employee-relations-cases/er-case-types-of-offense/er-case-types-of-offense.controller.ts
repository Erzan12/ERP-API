...
export class ErCaseTypesOfOffenseController {
  constructor(
    private readonly erCaseTypesOfOffenseService: ErCaseTypesOfOffenseService,
  ) {}
  ...
  getErTypeOfOffense(
    @Param('erCaseTypeOfOffenseId', new ParseUUIDPipe())
    erCaseTypeOfOffenseId: string,
    @SessionUser() user: RequestUser,
  ) {
    return this.erCaseTypesOfOffenseService.getTypeOfOffense(
