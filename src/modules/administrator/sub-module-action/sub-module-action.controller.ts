...
export class SubModuleActionController {
  ...
  getSubModulepermission(
    ...
    return this.submoduleActionService.getSubModuleAction(
  ...
  createSubModulePermission(
    ...
    return this.submoduleActionService.createSubModuleAction(
      addSubModuleDto,
      user,
    );
  }
  ...
  @ApiOperation({
    summary: 'Update a current sub module action/permission details',
  })
  ...
  updateSubmoduleAction(
    ...
    return this.submoduleActionService.updateSubmoduleAction(
      dto,
      user,
      subModuleActionId,
    );
