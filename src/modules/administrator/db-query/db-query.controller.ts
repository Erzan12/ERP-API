...
import { ApiPostResponse, ApiGetResponse } from 'src/utils/helpers/swagger-response.helper';
...
export class DbQueryControllerV2 {
    ...
    @Post('execute')
    @ApiBody({ type: ExecuteDbQueryDto, description: 'Payload for manual db query'})
