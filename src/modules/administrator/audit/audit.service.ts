...
export class AuditService {
    ...
    async log(data: AuditLogData): Promise<void> {
        try {
            ...
            const changedFields = data.changed_fields || this.detectChangedFields(
                data.old_values,
                data.new_values
            );
            ...
            await this.prisma.auditLog.create({
                data: {
                    ...
                    old_values: data.old_values ? JSON.parse(JSON.stringify(data.old_values)) : null,
                    new_values: data.new_values ? JSON.parse(JSON.stringify(data.new_values)) : null,
    ...
    private determineSeverity(data: AuditLogData): 'INFO' | 'WARNING' | 'CRITICAL' {
