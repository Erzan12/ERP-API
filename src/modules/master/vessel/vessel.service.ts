...
import { CreateVesselDetailsDto, CreateVesselWithDetailsDto, UpdateVesselWithDetailsDto } from './dto/vessel.dto';
...
export class VesselService {
    ...
    async updateVessel(user: RequestUser, dto: UpdateVesselWithDetailsDto, vesselId: string) {
            ...
            data: {
                ...
                vesselDetails:{
                    update: {
                        ...
                        year_last_drydocked: update_vessel_details.year_last_drydock ?? undefined,
                        place_last_drydocked: update_vessel_details.place_last_drydock ?? undefined,
                        ...
                        main_engine_rating: update_vessel_details.main_engine_rating ?? undefined,
                        main_engine_actual_rating: update_vessel_details.main_engine_actual_rating ?? undefined,
                        model_serial_no: update_vessel_details.model_serial_no ?? undefined,
                        estimated_fuel_consumption: update_vessel_details.estimated_fuel_consumption ?? undefined,
                        ...
                        maiden_voyage: update_vessel_details.maiden_voyage 
                            ...
                            : undefined,
                        min_main_engine_rating: update_vessel_details.min_main_engine_rating ?? undefined,
                        max_main_engine_rating: update_vessel_details.max_main_engine_rating ?? undefined,
                        auxillary_engine_1_rating: update_vessel_details.auxillary_engine_1_rating ?? undefined,
                        auxillary_engine_2_rating: update_vessel_details.auxillary_engine_2_rating ?? undefined,
                        auxillary_engine_3_rating: update_vessel_details.auxillary_engine_3_rating ?? undefined,
                        generator_set_rating: update_vessel_details.generator_set_rating ?? undefined,
                        crane_rating: update_vessel_details.crane_rating ?? undefined,
                        is_coupled_generator: update_vessel_details.is_coupled_generator ?? undefined,
                        min_service_knots: update_vessel_details.min_service_knots ?? undefined,
                        max_service_knots: update_vessel_details.max_service_knots ?? undefined,
                        bank_account_number: update_vessel_details.bank_account_number ?? undefined,
                        bank_account_name: update_vessel_details.bank_account_name ?? undefined,
                    }
                },
                updated_by: user.id
            }
