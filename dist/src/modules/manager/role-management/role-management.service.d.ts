...
export declare class RoleManagementService {
    ...
    createRolePermissions(createRolePermissionDto: CreateRolePermissionDto, user: RequestUser): Promise<{
        status: string;
        message: string;
        created_by: {
            id: string;
    ...
    addRoleUser(user: RequestUser, userId: string, roleName: string): Promise<{
        status: string;
        message: string;
        added_by: {
            id: string;
    ...
    addUserRolePermissions(userId: string, rolePermissionIds: string[], user: RequestUser): Promise<{
        message: string;
        roles: {
            description: string;
            id: string;
